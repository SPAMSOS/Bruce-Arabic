...
void OthersMenu::badUsbHidMenu() {
    options = {
#ifndef LITE_VERSION
        {"يو اس بي قاتل",        [=]() { ducky_setup(hid_usb, false); }   },
        {"لوحة مفاتيح يو اس بي", [=]() { ducky_keyboard(hid_usb, false); }},
#endif

#ifdef USB_as_HID
        {"نقرات يو اس بي",       clicker_setup                            },
#endif
