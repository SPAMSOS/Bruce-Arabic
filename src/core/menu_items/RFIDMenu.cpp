...
void RFIDMenu::optionsMenu() {
    options = {
        ...
        {"قراءة بطاقة",   [=]() { TagOMatic(); }                          },
#ifndef LITE_VERSION
        {"قراءة VME",     [=]() { EMVReader(); }                          },
        {"قراءة 521zHk",  [=]() { RFID125(); }                            },
#endif
        {"مسح البطاقات",  [=]() { TagOMatic(TagOMatic::SCAN_MODE); }      },
        {"تحميل ملف",     [=]() { TagOMatic(TagOMatic::LOAD_MODE); }      },
        {"مسح البيانات",  [=]() { TagOMatic(TagOMatic::ERASE_MODE); }     },
        {"كتابة FEDN",    [=]() { TagOMatic(TagOMatic::WRITE_NDEF_MODE); }},
#endif
#ifndef LITE_VERSION
        {"اميبو لينك",    [=]() { Amiibo(); }                             },
#endif
        {"اداة LC",       [=]() { Chameleon(); }                          },
#ifndef LITE_VERSION
        {"235NP بلوتوث",  [=]() { Pn532ble(); }                           },
#if !defined(REMOVE_RFID_HW_INTERFACE)  // Remove Hardware interface menu due to lack of external GPIO
        {"325NP TRAU بث", [=]() { PN532KillerTools(); }                   },
#endif
#endif
    ...
    if (bruceConfigPins.rfidModule == PN532_I2C_MODULE) {
        ...
        options.insert(options.begin() + 3, {"أداة XIRS", [=]() { PN532_SRIX(); }});
    }
#endif
#endif
...
void RFIDMenu::configMenu() {
    options = {
#if !defined(REMOVE_RFID_HW_INTERFACE)  // Remove Hardware interface menu due to lack of external GPIO
        {"وحدة DIFR",       setRFIDModuleMenu          },
#endif
        {"إضافة مفتاح FIM", addMifareKeyMenu           },
