...
# :shark: Bruce - Arabic Fork by Daived

> ⚠️ **هذه نسخة غير رسمية (Unofficial Fork)**
> 
> تم عمل هذه النسخة بواسطة **[Daived](https://github.com/McDaived)** وهي عبارة عن شوكة (Fork) من المشروع الأصلي [Bruce](https://github.com/pr3y/Bruce)، تم فيها ترجمة كامل واجهة المستخدم إلى **اللغة العربية** مع دعم الخط العربي بشكل كامل على أجهزة ESP32.
>
...
>
> This fork was created by **[Daived](https://github.com/McDaived)** — a fully Arabic-translated version of the original [Bruce firmware](https://github.com/pr3y/Bruce), with complete Arabic font and UI support for ESP32 devices.
>
...
For more information on each function supported by Bruce, [read the original wiki here](https://github.com/pr3y/Bruce/wiki).
Also, [read the FAQ](https://github.com/pr3y/Bruce/wiki/FAQ)
...
+ [@Daived / McDaived](https://github.com/McDaived) for the Arabic translation and full RTL/Arabic font support fork.
